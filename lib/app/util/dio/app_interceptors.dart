...
class AppInterceptors extends QueuedInterceptor {
  static AppInterceptors? _interceptors;
  AppInterceptors._internal();
  factory AppInterceptors() {
    return _interceptors ??= AppInterceptors._internal();
  }
    ...
    case DioErrorType.response:
      switch (statusCode) {
        ...
        case 404:
          ...
          break;
        case 409:
          errorMessage = DioErrorMessage.confictException;
          break;
        case 500:
...
class DioErrorMessage {
  static const badRequestException = 'Invalid Exception';
  static const internalServerErrorException =
      "Unknown error occurred, please try again later.";
  static const confictException = "Confict occurred";
  static const unauthorizedException = "Access Denied";
  static const notFoundException = "The request infomation could be not found";
